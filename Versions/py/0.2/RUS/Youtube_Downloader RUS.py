...
class YouTubeDownloaderPro(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.thumb_label = ctk.CTkLabel(mid, text="Превью", width=260, height=160)
    ...
    def fetch_metadata(self, url):
        ...
        def ui():
            ...
            self.quality_menu.configure(values=["best"] + qualities + ["только аудио"])
