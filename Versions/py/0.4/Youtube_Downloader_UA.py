...
class YouTubeDownloaderPro(ctk.CTk):
    ...
    def __init__(self):
        ...
        ctk.CTkLabel(mid, text="Тривалість:").grid(row=1, column=1, sticky="w")
        ...
        self.download_btn = ctk.CTkButton(bot, text="⬇ Скачати", command=self.start_download)
    ...
    def start_check(self):
        ...
        self.status_label.configure(text="Отримання інформації...")
    ...
    def start_download(self):
        if not self.info:
            messagebox.showwarning("Помилка", "Спочатку нажміть 🔍")
            return
